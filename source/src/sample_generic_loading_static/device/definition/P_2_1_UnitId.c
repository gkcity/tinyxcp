...
static TinyRet P_2_1_UnitId_SetValueRange(Property *thiz)
{
...
Property * P_2_1_UnitId(void)
{
    Property *thiz = NULL;

    do
    {
        thiz = Property_NewInstance(1, "xiot-spec", "unit-id", 0x00000000, NULL);
        if (thiz == NULL)
        {
            break;
        }
        ...
        if (RET_FAILED(P_2_1_UnitId_SetValueRange(thiz)))
        {
