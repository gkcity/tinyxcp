...
static void Fan_On_Changed(bool value)
{
    ...
    o = PropertyOperation_NewValue(DID, IID_FAN, IID_FAN_ON, JsonValue_NewBoolean(value));
    ...
    ret = Gateway_ChangePropertyValue(o);
    if (RET_FAILED(ret))
    {
...
//    strncpy(device->ip, "192.168.0.103", TINY_IP_LEN);
    device->port = 9898;
